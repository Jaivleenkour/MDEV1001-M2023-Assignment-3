    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
        {
            ...
            {
                if let showMovieDetailVC = segue.destination as? MovieDetailViewController
                {
                    showMovieDetailVC.movieViewController = self
                    if let indexPath = sender as? IndexPath
                    {
                       // Editing existing movie
                        let movie = self.arr_movies[indexPath.row]
                        showMovieDetailVC.movie = movie
                    } else {
                        // Adding new movie
                        showMovieDetailVC.movie = nil
                    }
                }
            }
        }
